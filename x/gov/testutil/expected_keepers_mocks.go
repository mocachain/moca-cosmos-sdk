...
func (m *MockCrossChainKeeper) GetReceiveSequence(ctx context.Context, destChainId types.ChainID, channelID types.ChannelID) uint64 {
	m.ctrl.T.Helper()
...
func (m *MockCrossChainKeeper) GetSendSequence(ctx context.Context, destChainId types.ChainID, channelID types.ChannelID) uint64 {
	m.ctrl.T.Helper()
