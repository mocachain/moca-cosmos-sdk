...
* (x/feegrant) Compare grantee/granter addresses by decoded value rather than string form in `GrantAllowance`, `RevokeAllowance`, and `Grant.ValidateBasic`. (MOCA-1263)
* (x/group) Compare admin and proposer addresses by decoded value rather than string form across group-admin, group-policy-admin, and proposal-withdrawal authorization checks. (MOCA-1263)
