...
require github.com/0xPolygon/polygon-edge v1.3.3
...
replace (
	// moca-patched in-tree SDK submodules — must match the root module's
	// replaces so simapp and cosmos-sdk resolve to the same code.
